package model;
/**
 * Tiger Subclass for Piece 
 * @author : Aedan Matienzo
 * @author : Carlo Cortez
 * @version : 3.0
 */
public class Tiger extends Piece implements Jump
{
    /**
     ...
     */
    Tiger (String animal, int nX, int nY, boolean bPieceColor, int nPieceRank, boolean bCaptureStatus) {
